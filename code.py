...
x_treino, x_teste, y_treino, y_teste = train_test_split(x, y, test_size=0.3)   #fazendo o treino e os testes da IA e o percentual de teste e treino

# Passo 3: Modelo de previsão ou modelo de IA 
...
# Avalio e escolho o melhor modelo 

# previsao 
previsao_arvore = modelo_arvoredecisao.predict(x_teste)
previsao_knn = modelo_knn.predict(x_teste)

# comparo a previsao com o y_teste
...
# importo novos clientes 
novos_clientes = pd.read_csv("novos_clientes.csv")

# não uso o fit antes do transform, pois se não ia criar outros numeroa para cada str
